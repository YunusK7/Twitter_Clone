import 'package:clone/homee/home.dart';
...
class _TwitterTabbarViewState extends State<TwitterTabbarView> {
  ...
  String pht ="https://accounts.google.com/SignOutOptions?hl=tr&continue=https://www.google.com%3Fhl%3Dtr";
  ...
  Widget get _appBarItems => Row(
        children: <Widget>[
          CircleAvatar(backgroundImage: NetworkImage(pht)),
          _emptyWidht,
